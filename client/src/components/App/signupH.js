...
import { TextField, Button, Container, Typography, Grid, Paper, Link, IconButton, InputAdornment, MenuItem } from "@mui/material";
...
const SignupFormH = () => {
  ...
  return (
    <div style={{ backgroundColor: "#f7f9f6", minHeight: "100vh", display: "flex", justifyContent: "center", alignItems: "center", paddingBottom: "2rem" }}>
      <Container maxWidth="sm">
        <Paper elevation={1} style={{ padding: "2rem", width: "100%", border: "1px solid #b0b8a6", borderRadius: "8px", boxShadow: "none" }}>
          <Typography variant="h5" align="center" style={{ color: "#3e4b32", fontWeight: "600" }} gutterBottom>
            Create your new <strong>Healthcare Professional</strong> account
          </Typography>
          <Typography variant="body2" align="center" style={{ color: "#7d8a6a" }} gutterBottom>
          ...
          <form noValidate autoComplete="off" onSubmit={handleSubmit}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <TextField fullWidth label="MINC Number" name="mincNumber" variant="outlined" placeholder="Enter your MINC number..." value={formValues.mincNumber} onChange={handleChange} error={!!errors.mincNumber} helperText={errors.mincNumber} />
              </Grid>
              <Grid item xs={6}>
              ...
              <Grid item xs={12}>
                <TextField select fullWidth label="Hospital" name="hospital" variant="outlined" value={formValues.hospital} onChange={handleChange} error={!!errors.hospital} helperText={errors.hospital}>
              ...
              <Grid item xs={12}>
                <TextField select fullWidth label="Specialty" name="specialty" variant="outlined" value={formValues.specialty} onChange={handleChange} error={!!errors.specialty} helperText={errors.specialty}>
              ...
              <Grid item xs={12}>
                <TextField fullWidth label="Password" name="password" variant="outlined" type={showPassword ? "text" : "password"} value={formValues.password} onChange={handleChange} error={!!errors.password} helperText={errors.password} InputProps={{
                  endAdornment: (
              ...
              <Grid item xs={12}>
                <Button fullWidth variant="contained" type="submit" style={{ backgroundColor: "#e3ebdc", color: "#3e4b32", fontWeight: "bold", padding: "12px", borderRadius: "8px" }}>
                  Sign Up
                </Button>
              </Grid>
            </Grid>
          </form>
          <Typography variant="body2" align="center" style={{ marginTop: "2rem", paddingBottom: "1rem", color: "#7d8a6a" }}>
