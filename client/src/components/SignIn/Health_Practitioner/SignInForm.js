...
import { TextField, Checkbox, FormControlLabel, Button, Typography, Grid, Link, Box } from '@mui/material'
    ...
    <div className="login-form-container">
      ...
      <form onSubmit={handleSubmit}>
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <TextField
              label="Medical Identification Number for Canada"  // Label above the input
              type="text"
              name="MINC"
              fullWidth
              value={formData.MINC}
