...
import { 
  TextField, Checkbox, FormControlLabel, Button, Typography, Grid, Link, Box, Paper, Container, 
...
function SignInFormP() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await firebase.doSignInWithEmailAndPassword(formData.healthCard, formData.password);
      console.log("User signed in successfully!");
      navigate('/Home'); // Redirect user to the main dashboard after successful sign-in
    } catch (err) {
