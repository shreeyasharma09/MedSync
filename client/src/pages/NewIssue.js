...
const specialtyDescriptions = {
  'Emergency Medicine':
    'Handles urgent and life-threatening conditions in the ER.',
  'Intensive Care (Critical Care Medicine)':
    'Manages patients in the ICU needing constant monitoring.',
  'Internal Medicine':
    'Focuses on preventing, diagnosing, and treating adult diseases.',
  Cardiology:
    'Specializes in heart-related conditions like hypertension and heart attacks.',
  Pulmonology: 'Deals with lung conditions like asthma, COPD, and pneumonia.',
  Gastroenterology:
    'Manages digestive issues like acid reflux, IBS, and liver diseases.',
  Nephrology:
    'Specializes in kidney diseases, dialysis, and high blood pressure.',
  Endocrinology:
    'Handles hormone-related issues such as diabetes and thyroid disorders.',
  Hematology:
    'Deals with blood disorders like anemia, leukemia, and clotting issues.',
  'Infectious Disease':
    'Treats bacterial, viral, and parasitic infections such as COVID-19 and HIV.',
  Rheumatology: 'Manages autoimmune diseases like arthritis and lupus.',
  'General Surgery':
    'Performs surgeries for appendicitis, hernias, and other conditions.',
  'Cardiothoracic Surgery':
    'Conducts heart and lung surgeries, including bypass surgery.',
  Neurosurgery:
    'Handles brain and spinal surgeries for conditions like tumors or injuries.',
  'Orthopedic Surgery': 'Deals with bones, joints, and sports injuries.',
  'Plastic & Reconstructive Surgery':
    'Performs cosmetic and reconstructive surgeries.',
  'Otolaryngology (ENT)':
    'Treats ear, nose, and throat conditions, including allergies and sinus infections.',
  Urology: 'Specializes in urinary and reproductive system issues.',
  'Vascular Surgery':
    'Manages blood vessel conditions like varicose veins and aneurysms.',
  'Obstetrics & Gynecology (OB/GYN)':
    'Cares for women’s reproductive health and pregnancy.',
  ...
  Neurology:
    'Treats brain and nervous system conditions like migraines and epilepsy.',
  Psychiatry:
    'Manages mental health conditions such as anxiety and depression.',
  ...
  'Palliative Care':
    'Provides comfort care for patients with serious illnesses.',
  Radiology: 'Interprets imaging studies like X-rays, MRIs, and CT scans.',
  'Interventional Radiology':
    'Performs minimally invasive procedures guided by imaging.',
            ...
            <Paper sx={{p: 3, mt: 2, bgcolor: '#E1E9D8', borderRadius: 2}}>
              ...
              {Object.entries(specialtyDescriptions).map(([key, value]) => (
                <Box key={key} sx={{mt: 1}}>
                  <Typography
                    variant="subtitle1"
                    sx={{fontWeight: 600, color: '#2f3b26'}}
                  >
                    {key}
                  </Typography>
