...
export default function HealthcareDashboard() {
  ...
  // Example stats—replace with real data from your backend
  ...
  const goToSchedule = () => {
    navigate("/HealthcareBookings"); // or whichever route you use
  };
        ...
        {appointments.length === 0 ? (
          ...
          <List disablePadding>
            {appointments.map((appt) => {
              ...
              // Decide color & label for status chip
              let chipLabel = appt.status;
              let chipBg = "#d0dfc7"; // default for "Checked In"
              let chipColor = "#3e4b32";

              if (appt.status === "Scheduled") {
                chipBg = "#dceeff"; // pale blue
                chipColor = "#1565c0";
              }
              ...
              return (
                ...
                >
                  {/* Left side: Avatar + name/time/reason */}
